...
* Puya PY32F0 MCU series
* GNU Arm Embedded Toolchain
* J-Link and DAPLink/PyOCD programmers
...
Download the toolchain from [Arm GNU Toolchain Downloads](https://developer.arm.com/downloads/-/arm-gnu-toolchain-downloads) according to your architecture, extract the files
...
This repo is based on [IOsetting/py32f0-template](https://github.com/IOsetting/py32f0-template).
